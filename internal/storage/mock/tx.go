...
func (mr *MockITxMockRecorder) ByHeight(ctx, height, limit, offset any) *ITxByHeightCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ByHeight", reflect.TypeOf((*MockITx)(nil).ByHeight), ctx, height, limit, offset)
	return &ITxByHeightCall{Call: call}
}

// ITxByHeightCall wrap *gomock.Call
type ITxByHeightCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *ITxByHeightCall) Return(arg0 []storage.Tx, arg1 error) *ITxByHeightCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *ITxByHeightCall) Do(f func(context.Context, types.Level, int, int) ([]storage.Tx, error)) *ITxByHeightCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *ITxByHeightCall) DoAndReturn(f func(context.Context, types.Level, int, int) ([]storage.Tx, error)) *ITxByHeightCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
