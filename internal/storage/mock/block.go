...
func (mr *MockIBlockMockRecorder) ByHeight(ctx, height, withStats any) *IBlockByHeightCall {
	mr.mock.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *IBlockByHeightCall) Do(f func(context.Context, types.Level, bool) (storage.Block, error)) *IBlockByHeightCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *IBlockByHeightCall) DoAndReturn(f func(context.Context, types.Level, bool) (storage.Block, error)) *IBlockByHeightCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (mr *MockIBlockMockRecorder) ByProposer(ctx, proposerId, limit, offset, order any) *IBlockByProposerCall {
	mr.mock.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *IBlockByProposerCall) Do(f func(context.Context, uint64, int, int, storage0.SortOrder) ([]storage.Block, error)) *IBlockByProposerCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *IBlockByProposerCall) DoAndReturn(f func(context.Context, uint64, int, int, storage0.SortOrder) ([]storage.Block, error)) *IBlockByProposerCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
