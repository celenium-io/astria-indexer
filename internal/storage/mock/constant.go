...
import (
	...
	types "github.com/aopoltorzhicky/astria/internal/storage/types"
...
func (mr *MockIConstantMockRecorder) IsNoRows(err any) *IConstantIsNoRowsCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsNoRows", reflect.TypeOf((*MockIConstant)(nil).IsNoRows), err)
	return &IConstantIsNoRowsCall{Call: call}
}

// IConstantIsNoRowsCall wrap *gomock.Call
type IConstantIsNoRowsCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *IConstantIsNoRowsCall) Return(arg0 bool) *IConstantIsNoRowsCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *IConstantIsNoRowsCall) Do(f func(error) bool) *IConstantIsNoRowsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *IConstantIsNoRowsCall) DoAndReturn(f func(error) bool) *IConstantIsNoRowsCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
