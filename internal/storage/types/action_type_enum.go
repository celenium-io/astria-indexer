...
const (
	...
	// ActionTypePriceFeed is a ActionType of type price_feed.
	ActionTypePriceFeed ActionType = "price_feed"
)
...
var _ActionTypeValue = map[string]ActionType{
	...
	"price_feed":                ActionTypePriceFeed,
}
