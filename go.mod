...
require (
	buf.build/gen/go/astria/primitives/protocolbuffers/go v1.34.1-20240522171750-37ae32102c04.1
	buf.build/gen/go/astria/protocol-apis/protocolbuffers/go v1.34.1-20240522171751-290c92691985.1
